...
class UserController extends Controller
{
    ...
    public function login(Request $request){
       ...
       Session::put("user_login",$request->email);
          ...
          $checkplan=UserPlan::where("user_email",$request->email)->first()->toArray();
          if(!empty($check)){
   ...
   public function GoogleLogin()
    ...
    public function planShow(){
     ...
     return view("useradmin.page.my-plan.my_plan",compact('accomodation','tour','fooddrink','transportation','accomodation_data','tour_data','fooddrink_data','transportation_data'));
