...
class TranportationController extends Controller
{
    ...
    $transportation=CMSTransportation::where("status",1)->get()->toArray();
  
    return view("admin.page.transportation.add_transportation",compact('language','city','transportation'));
   ...
   public function create(Request $request){
     ...
     $custom_rule=[
        ...
        "type.in"=>"Select Transportation Type",
   ...
   public function show_list(){
    $data=Transportation::latest()->get();
   ...
   //status change
    ...
    public function edit(Request $request,$id){
        ...
        return view("admin.page.transportation.transportation_edit",compact('data','language','city','transportation'));
    }
    ...
    public function edit_data(Request $request){
     ...
     if($validate->fails()){
        ...
        if(Transportation::where("id",$request->id)->update($data)){
           ...
           $rule=[
     "name"=>"required",
     "type"=>"required|in:transfer,private_driver,car_rental,public_transportation",
