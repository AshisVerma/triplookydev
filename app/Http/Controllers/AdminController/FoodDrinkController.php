...
class FoodDrinkController extends Controller
{
    public function index(){
        ...
        return view("admin.page.food-drink.add_food_drink",compact('city'));
    }
    ...
    public function create(Request $request){
     $rule=[
     "name"=>"required",
     "type"=>"required|in:resturant,bar,coffee,nightlife",
     ...
     $custom_rule=[
        ...
        "type.in"=>"Select Food and Drink Type",
   ...
   //status change
    ...
    public function edit(Request $request,$id){
        ...
        return view("admin.page.food-drink.food_drink_edit",compact('data','city'));
    }
