...
//date diff
	...
	//prevent not add more day after select travelling date
      ...
      var all_select_city=$(".pick-city-box label.prevSelected");
      
       $(all_select_city).each(function(i){
         if($(this).parent().find("div.number").css("display")==="block"){
        ...
        if(total_day>=difference_day){
            swal({
                 title: "Total Trip is "+difference_day+" Days",
                 text: "Can`t be select More than "+difference_day+" Days",
                 icon: "error",
                  dangerMode: true,
                   button: {
                   text: "Close",
           ...
           if(difference_day>total_day){
              ...
              var tour_data=JSON.parse(sessionStorage.getItem("tour"));
       	    if(sessionStorage.getItem("city_details")!=null){
       	    	...
       	    	var all_city_details=JSON.parse(sessionStorage.getItem("all_city_details"));
       	    	var data=JSON.parse(sessionStorage.getItem("tour"));
       	    	...
       	    	$(all_select_city).each(function(){
       	    		...
       	    		if(Number(day)>0){
       	    		   ...
       	    		   data.push(object);
       	    		   tour_data.city.push($(this).attr("data"));
