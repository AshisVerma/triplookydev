                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="form-box">
                            <div class="card" style="border:none;box-shadow: 0px 0px 5px black;border-radius: 2px;">
                                ...
                                <div class="card-body">
                                     <form action="/admin/food-and-drink/update-food-and-drink-data"    enctype="multipart/form-data" method="post">
                                        @csrf
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                          ...
                                          <select class="form-control shadow-none" name="type">
                                              ...
                                              <option value="resturant" @if ($data->type=='resturant') selected="selected" @endif>Resturant</option>
                                              <option value="bar" @if ($data->type=='bar') selected="selected" @endif>Bar</option>
                                              <option value="coffee" @if ($data->type=='coffee') selected="selected" @endif>Coffee</option>
                                              <option value="nightlife" @if ($data->type=='nightlife') selected="selected" @endif>Nightlife</option>
