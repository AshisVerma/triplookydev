                    ...
                    <div class="col-lg-12">
                        <div class="form-box">
                            <div class="card" style="border:none;box-shadow: 0px 0px 5px black;border-radius: 2px;">
                                ...
                                <div class="card-body">
                                     <form action="/admin/city/update-city-data" enctype="multipart/form-data" method="post">
                                        @csrf
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                           ...
                                           <textarea class="form-control shadow-none" placeholder="City Description" name="description" oninput="removeErrorshow(this)">
                                               {{$data->description}}
                                           </textarea>
