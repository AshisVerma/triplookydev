                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="form-box">
                            <div class="card" style="border:none;box-shadow: 0px 0px 5px black;border-radius: 2px;">
                                ...
                                <div class="card-body">
                                    <form method="post" action="/admin/must-do-and-see/add-must-do-and-see-add" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control shadow-none" name="description" placeholder="Must Do And See Description" rows="6">
                                                {{old('description')}}
                                            </textarea>
