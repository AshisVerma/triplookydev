                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="form-box">
                            <div class="card" style="border:none;box-shadow: 0px 0px 5px black;border-radius: 2px;">
                                ...
                                <div class="card-body">
                                     <form action="/admin/accomodation/add-accomodation-data"    enctype="multipart/form-data" method="post">
                                        @csrf
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <input type="number" name="phone" class="form-control shadow-none" placeholder="Phone No"  value="{{old('phone')}}" maxlength="10" id="phone">
                                             @if($errors->has('phone'))
