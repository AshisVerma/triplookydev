                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="form-box">
                            <div class="card" style="border:none;box-shadow: 0px 0px 5px black;border-radius: 2px;">
                                ...
                                <div class="card-body">
                                     <form action="/admin/transportation/add-transportation"    enctype="multipart/form-data" method="post">
                                        @csrf
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                          ...
                                          <select class="form-control shadow-none" name="type">
                                              ...
                                              <option value="{{$transportation[$i]['name']}}"  {{$transportation[$i]['name']==old('type')?"selected":""}}>{{$transportation[$i]['name']}}</option>
                                              @endfor
