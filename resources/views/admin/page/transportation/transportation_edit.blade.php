...
<div class="row align-items-center">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="form-box">
                            <div class="card" style="border:none;box-shadow: 0px 0px 5px black;border-radius: 2px;">
                                ...
                                <div class="card-body">
                                     <form action="/admin/transportation/update-transportation-data"    enctype="multipart/form-data" method="post">
                                        @csrf
                                         ...
                                         <div class="form-group">
                                          ...
                                          <select class="form-control shadow-none" name="type">
                                              <option>Select Type</option>
                                               ...
                                               <option value ="{{$transportation[$i]['name']}}" {{$data->type==$transportation[$i]['name']?"selected":""}} >{{$transportation[$i]['name']}}</option>
                                               @endfor
        ...
        <option value="{{$lang->lang_name}}" {{$data->driver_language==$lang->lang_name?"selected":""}}>{{$lang->lang_name}}</option>
                                                @endforeach
                                        ...
                                        <div class="form-group shadow-none">
                                            ...
                                            <select class="selectpicker form-control shadow-none" name="city[]"  multiple data-actions-box="true">
                                                ...
                                                @foreach($city as $key=> $city_list)
                                                  @if(in_array($city_list->id,$city_data))
                                                   <option value="{{$city_list->id}}" selected="">{{$city_list->city_name}}</option>
                                                  @else
