...
<main id="main">
   ...
   <section class="form-section" id="pdt-30">
     ...
     $city_data[$key]=json_decode($city_details,true);
     ...
     for($i=0;$i<count($city_data);$i++){
       $city_id[$i]= (base64_decode($city_data[$i]['data']));
       $id=(base64_decode($city_data[$i]['data']));
       $city_day[$id]=(base64_decode($city_data[$i]['day']));
 }
      }
            ...
            @foreach($data as $list)
             ...
             <div class="form-group wow fadeInLeft" data-wow-duration="2s" data-wow-delay="0.5s">
               ...
               <div class="button-group-pills text-center" data-toggle="buttons">
                <div class="citiesS" style="position: relative;">
                  <a href="javascript:void(0);" class="info-cities city-info-link position-relative" data="{{$list->id}}" city_name={{$list->city_name}}><i class="fa-solid fa-circle-info" ></i> Details</a>
                  <label class="btn btn-default prevSelected pick-city-box" data="{{$list->id}}" style="position: absolute !important;z-index: -1 !important;">
                    <span class="checkCircle"></span>
                    <input type="checkbox" class="chbox" name="options" getcity="yes">     
                   ...
                   @else
                    <input class="pm days" type="text" data="{{$list->id}}" name="day[]" value="" readonly>
                   @endif
                    <span class="oneN" style="display: none;">Night</span>
                    <span class="twoN" style="display: block;">Nights</span>
