               ...
               <div class="city_slider" style="overflow: hidden;">
                  <div class="swiper-container" id="dd11">
                     <div class="swiper-wrapper">
                      <div id="city-carousel" class="carousel carousel-fade animat" data-bs-ride="carousel"  data-bs-interval="false">
            ...
            <div class="d-flex align-center justify-content mt-2 wow fadeInRight">
              ...
              <div class="swiper-wrapper">
                ...
                <!---accomodation list display selected from accomodation page accoding to city  ---->
                 ...
                 @for($j=0;$j<count($accomodation[$i]);$j++)
                  <div class="swiper-slide selct" style="width:33.3333%">
                     <div class="citiesS accomodation-div" data="{{$accomodation[$i][$j]['city']}}">
              ...
              <div class="swiper-button-next">
               ...
               <div class="sTbudget wow fadeInRight" style="">
                  <b>{{session('currency_sign')}}</b><span class="accomodation-total-price price">0</span><span style=""><i class="fas fa-coins"></i> </span>
               </div>
            </div>
            ...
            <div class="d-flex align-center justify-content mt-3 wow fadeInRight">
               ...
               <div class="swiper-container activities_slider slick" id="mln-7">
                 ...
                 @for($j=0;$j<count($activity[$i]);$j++)
                  <div class="swiper-slide selct">
                     <div class="citiesS tour-div" data="$activity[$i][$j]['city']">
                     <span class="checkCircle"></span>
               ...
               <div class="sTbudget wow fadeInRight" style="">
                  <b>{{session('currency_sign')}}</b> <span class="activity-total-price price">0</span><span style=""><i class="fas fa-coins"></i></span>
               </div>
            </div>
            ...
            <div class="d-flex align-center justify-content mt-3 wow fadeInRight">
               ...
               <div class="swiper-container slick" id="food_slider">
                 ...
                 @for($j=0;$j<count($fooddrink[$i]);$j++)
                  <div class="swiper-slide selct">
                     <div class="citiesS fooddrink-div" data="{{$fooddrink[$i][$j]['city']}}">
                     <span class="checkCircle"></span>
               ...
               <div class="sTbudget wow fadeInRight" style="">
                  <b>{{session('currency_sign')}}</b><span class="food-and-drink-total-price price">0</span> <span style=""><i class="fas fa-coins"></i></span>
               </div>
            </div>
            ...
            <div class="d-flex align-center justify-content mt-3 mb-5 wow fadeInRight">
               ...
               <div class="swiper-container transportation_sl" id="transportation_slider">
                 ...
                 @for($j=0;$j<count($transportation[$i]);$j++)
                  <div class="swiper-slide selct">
                     <div class="citiesS transport-div" data="{{$transportation[$i][$j]['city']}}">
                     <span class="checkCircle"></span>
               ...
               <div class="sTbudget" style="">
                  <b>{{session('currency_sign')}}<span class="transportation-total-price price">0</span></b> <span style=""><i class="fas fa-coins"></i></span>
               </div>
            </div>
            <!-- Close -->
            <div class="text-center">
 ...
 //filter function call //
  ...
  $(document).ready(function(){
    ...
    //city next move and day next move and filteration on accomodation,tour and activity,fooddrink,transportation
     var id=($("#city-carousel .carousel-item.active").attr("data"));
   filter_data(id);
  });
...
//remove transportation from session storage
  ...
  return arr.some(function(el) {
   ...
   //add accomodation after click add tour trip button
  ...
  //end add accomodation after user click on add to trip button
   //---------- ADD ACCOMODATION -------------------//

   //------------ TOUR AND ACTIVITY -----------------//

   // add tour and activity  after click on add to trip button
      ...
      //end add tour and activity after click on add trip button
   // --------------- TOUR AND ACTIVITY --------------//
   ...
   for(i=0;i<difference_day+1;i++){
    ...
    day_date=day_date.toLocaleDateString('pt-PT');
   	...
   	var box=`<div class="swiper-slide">
                           Day <span class='day-no' date="`+day_date+`" day="`+eval(i+1)+`">`+(i+1)+`</span>
                        </div>`;
...
//reset all your data from session storage
...
// -------------- END RESET PRESELECTED DATA------------//
  ...
  filter_data(city_id);
   ...
   //accomodation,transportation,tour,fooddrink filteration start coding on the behalf of active city 
