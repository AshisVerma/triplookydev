         ...
         <div class="modal-body">
            ...
            <div class="d-flex justify-bw align-center">
               <div class="w-50" style="text-align:justify;">
                  ...
                  <p><b style="margin-right: 16px;">Price : </b> <span class="accomodation-price"></span> (Per person, Per Night)</p>
         ...
         <div class="modal-body">
            ...
            <div class="d-flex justify-bw align-center">
               <div class="w-50" style="text-align:justify;">
                  ...
                  <p><b style="margin-right: 16px;">Price : </b> <span class="activity-price"></span> (Per person, Per Night)</p>
         ...
         <div class="modal-body">
            ...
            <div class="d-flex justify-bw align-center">
               <div class="w-50" style="text-align:justify;">
                  ...
                  <p><b style="margin-right: 16px;">Price : </b> <span class="fooddrink-price"></span> (Per person, Per Night)</p>
         ...
         <div class="modal-body">
            ...
            <div class="d-flex justify-bw align-center">
               <div class="w-50" style="text-align:justify;">
                  ...
                  <p><b style="margin-right: 16px;">Price : </b> <span class="transportation-price"></span> (Per person, Per Night)</p>
