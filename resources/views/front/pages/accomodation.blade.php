       ...
       <form id="accomodation-form">
          ...
          @for($i=0;$i<count($data);$i++)
           @if(session()->has('accomodation'))
            ...
            <div class="accomodation-box w-20 wow fadeInLeftBig" data-wow-duration="2s" data-wow-delay="0.2s" data="{{$data[$i]['name']}}">
              <div class="form-group">                
                <div class="text-center">{{$data[$i]['name']}}</div>
                <div class="button-group-pills text-center" data-toggle="buttons">
                  <label class="btn btn-default prevSelected active" id="hotls">
                    <span class="checkCircle"></span>
                    <input type="checkbox" class="chbox" name="options" value="transfer"  select_accomodation="yes">
              ...
              <div class="form-group">                
                ...
                <div class="button-group-pills text-center" data-toggle="buttons">
                  <label class="btn btn-default" id="hotls">
                    <span class="checkCircle"></span>
                    <input type="checkbox" class="chbox selected" name="options" value="transfer">
                    <img src="{{url('')}}/accomodation-image/images/{{$data[$i]['image']}}" class="lbImg">
                  </label>
                </div>
              </div>
  ...
  $(document).ready(function(){
   ...
   $(".accomodation-box").each(function(){
    $(this).click(function(){
       ...
       if(accomodation.indexOf($(this).attr("data"))==-1){
                accomodation.push($(this).attr("data"));
                 $(this).find("input").attr("select_accomodation","yes");
              }
