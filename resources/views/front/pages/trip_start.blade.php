...
<main id="main">
  ...
  <section class="tripStart">
  <div class="timelineSection">
               <div class="container-fluid bodyPad mt-3">
                <div class="proBar">
...
var date2 = new Date(+dateParts2[2], dateParts2[1] - 1, +dateParts2[0]); 
          ...
          var day_length=(response.data.length);
         $(response.data).each(function(index,data){
         
     numberOfDaysToAdd += Number(atob(city_details[index].day));
...
var departure_date = new Date(date1.getTime()+(numberOfDaysToAdd*24*60*60*1000));
        ...
        var box=` <div class="timilineBox draggable-item">
                     <div class="timeBox numericBox">
                        <span class="nm">`+(index+1)+`</span> <span class="tt">`+(data.city_name)+`</span> <i class="fas fa-sort-down"></i>
                     </div>
