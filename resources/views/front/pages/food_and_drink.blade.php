       ...
       <form id="tour-form-data">
         <div class="text-center mb-5"> 
          ...
          <div class="range-slider flat" data-ticks-position='top' style='--min:00; --max:2500; --value-a:0; --value-b:400; --prefix:"$"; --text-value-a:"0"; --text-value-b:"400";width:50%;'>
            <input type="range" min="0" max="2500"  oninput="this.parentNode.style.setProperty('--value-a',this.value); this.parentNode.style.setProperty('--text-value-a', JSON.stringify(this.value))" class="food-and-drink-min-price">
            <output></output>
            <input type="range" min="0" max="2500"  oninput="this.parentNode.style.setProperty('--value-b',this.value); this.parentNode.style.setProperty('--text-value-b', JSON.stringify(this.value))" class="food_drink_budget food-and-drink-max-price">
            <output></output>
...
<script type="text/javascript">
  ...
  //tour form submit
  $("#tour-form-data").submit(function(e){
     e.preventDefault();
    alert($(".food_drink_budget").val());
    alert($(".food-and-drink-max-price").val());
    alert($(".food-and-drink-min-price").val());
    return false;
