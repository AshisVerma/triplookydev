...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-confirm/3.3.2/jquery-confirm.min.js"></script>
            ...
            <nav id="navbar" class="navbar">
               <ul class="navbar-left text-left">
                ...
                @if(session()->has('user_login'))
                 ...
                 <li>
                   <a class="nav-link scrollto" href="/user/save-plan-list" >My Plan</a>
                 </li>
                 @endif
                @endif
    ...
    <a class="dropdown-item" href="/user/dashboard-admin">My Profile</a>
                     ...
                     @else
                     <a class="nav-link scrollto login-modal-link" href="javascript:void(0)" data-controls-modal="your_div_id" data-backdrop="static" data-keyboard="false">Log In</a>
                     @endif
                  </li>
               ...
               <div class="modal-body p-0" style="background:white">
                  <div class="wrapper-section">
                     ...
                     <div class="login-bottom mt-2">
                        <p class="p-0 m-0">Alredy a member?<a href="javascript:void(0)" class="open-login-modal">Login</a></p>
                     </div>
